...
*/
vector<int32_t> ServerClientInterface::get_vec(){
    return vec;
}
...
*/
void ServerClientInterface::set_vec(vector<int32_t> v){
    vec = v;
}
...
*/
int32_t ServerClientInterface::sum_vec(){
    int32_t sum = 0;
